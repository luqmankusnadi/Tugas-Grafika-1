...
int main()
{
    ...
    for (i=vinfo.yres-1;i>=0;i--){
        drawString("Luqman Faizlani Kusnadi", 0, i, 2, (Color32){255*i/vinfo.yres,255-(255*i/vinfo.yres),255,255});
        usleep(10000);
		drawString("Luqman Faizlani Kusnadi", 0, i, 2, (Color32){0,0,0,0});
    }
